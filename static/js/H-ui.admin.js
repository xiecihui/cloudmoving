...
function tabNavallwidth(){
	...
	$tabNavitem.each(function(index, element) {
        taballwidth+=Number(parseFloat($(this).width()+50))
    });
...
/*弹层*/
var index;
function detailbtn(title,url,w,h,btn,gohtml,data){
    index = layer.open({
        type: 2,
        area: [w, h],
        offset: ['13%'],
...
/* 父级弹层*/
function parentLayer(title,url,w,h,btn,gohtml,data){
    parent.layer.open({
        type: 2,
        area: [w, h],
        offset: ['13%'],
...
/*提示*/
function titlayer(tit){
	layer.msg(tit,{offset: ['35%', '42%'],time: 1500});
}
